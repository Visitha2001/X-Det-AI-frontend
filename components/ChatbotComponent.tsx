...
export default function ChatbotComponent({ disease }: ChatbotComponentProps) {
  ...
  const loadSuggestedQuestions = async () => {
    try {
      const response = await chatService.getSuggestedQuestions(disease);
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const response = await chatService.sendQuery({
        question: input,
        disease: botType === 'local' ? disease : undefined,
      });
  ...
  return (
    <div className="flex flex-col sm:h-200 h-180 mx-auto border border-gray-700 bg-gray-800 rounded-xl shadow-lg overflow-hidden">
      {/* Header */}
      <div className="bg-gray-800 text-gray-100 p-4">
        ...
        <div className="flex flex-wrap items-center justify-between mt-2 gap-2">
          ...
          <div className="flex items-center">
            ...
            <span className="bg-gray-700 text-gray-100 rounded-xl px-2 py-1">
              {disease}
            </span>
            <button
      ...
      <div className="p-4 border-t border-gray-700 bg-gray-800">
        <div className="flex">
          <textarea
            ...
            placeholder={botType === 'local' ? `Ask about ${disease}...` : 'Ask any medical question...'}
