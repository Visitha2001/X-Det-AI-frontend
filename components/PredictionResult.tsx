...
export default function PredictionResults({
  ...
  if (scanError) {
    return (
      <div className="w-full bg-gray-800/50 rounded-lg p-6 mt-4 max-w-3xl mx-auto border border-gray-700">
  ...
  return (
    <div className="w-full p-2 bg-black">
      ...
      <div className="relative bg-gray-800/80 rounded-4xl sm:px-40 sm:py-11 max-w-full mx-auto overflow-hidden border border-gray-800/30">
              ...
              <>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {prediction.top_5_diseases.map((item, index) => (
                    <div key={index} className="bg-gray-700/50 rounded-2xl p-4 border border-blue-500/20 shadow-lg">
                ...
                <div className="mt-6">
                  <button
                    ...
                    className="inline-flex items-center cursor-pointer px-5 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium rounded-2xl shadow-md hover:from-blue-700 hover:to-blue-800 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isProcessing ? (
                      <>
